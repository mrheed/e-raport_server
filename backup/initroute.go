...
func InitRoute() {
	...
	// Nilai UH route
	Router.HandleFunc("/api/nilai_uh", AppendExamScoreController).Methods("POST", "OPTIONS")
	Router.HandleFunc("/api/nilai_uh", GetExamScoreController).Methods("GET", "OPTIONS")
	Router.HandleFunc("/api/nilai_uh", AppendRemedyScoreController).Methods("PUT", "DELETE", "OPTIONS")
	// Nilai PTPAS route
